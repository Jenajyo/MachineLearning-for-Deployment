...
for year in range(1880,2019):
    names.append(pd.read_csv(f'/Users/jyotiranjanjena/pCloud Drive/DataScientist/Python Certification Training Course imp/Python Assignments and Projects/names/yob{year}.txt',names=['Names','Gender','Frequncy']))
    names[-1]['Year']=year
